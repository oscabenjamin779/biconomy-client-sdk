...
import { PaymasterFeeQuote, UserOperation } from '@biconomy-devx/core-types'
import { HttpMethod, sendRequest } from './utils/httpRequests'
import { PaymasterConfig, TokenPaymasterData } from '@biconomy-devx/core-types'
...
export class BiconomyTokenPaymasterAPI extends PaymasterAPI<TokenPaymasterData> {
  ...
  async createTokenApprovalRequest(
    ...
    // TODO // fix it with request based spender
